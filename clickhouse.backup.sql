...
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_blob_triggers', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_calendars', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_cron_triggers', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_fired_triggers', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_job_details', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_locks', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_paused_trigger_grps', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_scheduler_state', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_simple_triggers', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_simprop_triggers', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'qrtz_triggers', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_announcement', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_announcement_send', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_category', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_check_rule', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_data_log', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_data_source', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_depart', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_depart_permission', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_depart_role', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_depart_role_permission', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_depart_role_user', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_dict', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_dict_item', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_fill_rule', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_log', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_permission', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_permission_data_rule', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_position', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_quartz_job', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_role', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_role_permission', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_sms', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_sms_template', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_user', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_user_agent', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_user_depart', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'sys_user_role', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_channel', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_channel_listener', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_chatroom', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_friend', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_friend_request', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_group', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_group_member', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_id_generator', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_messages', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_robot', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_sensitiveword', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_thing', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_user', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_user_messages', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_user_session', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_user_setting', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 't_user_status', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_bridge', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_dashboard', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_download_token', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_footprint', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_image_cache', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_matter', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_preference', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_session', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_share', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_upload_token', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'tank30_user', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_admin', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_author', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_author_info', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_avatar', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_depart_name', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_fans', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_handled_events', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_handled_events_unq', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_handling_events', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_hrmresource', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_messages', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_resource', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_reward_data', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_seal_max', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_slink', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_table_field', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_table_info', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_table_name', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_uname', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_user', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_user_monthly', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_visit_month', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_visit_total', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_watch', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_workflow_daily', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_workflow_monthly', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_workflow_node', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_workflow_total', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'v_workflow_type_node', 'mysqldumpuser', 'mysqldumpuser') ;
