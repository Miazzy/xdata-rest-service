...
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_advice', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_comment', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_douban', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_evaluation', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_img', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_menu', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_news', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_news2', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_theme', 'mysqldumpuser', 'mysqldumpuser') ;
CREATE TABLE bs_admin_group ENGINE = MergeTree ORDER BY id AS SELECT * FROM mysql('172.18.254.95:3309', 'jeecg-boot', 'w_user', 'mysqldumpuser', 'mysqldumpuser') ;
